...
const (
	...
	SqlCreateParkingTbl = "CREATE TABLE `z_parking` (`id` int unsigned NOT NULL DEFAULT '0', `count` int unsigned NOT NULL DEFAULT '0', `info` varchar(255) NOT NULL DEFAULT '', PRIMARY KEY (`id`));"
	...
	SqlCreateRecordTbl  = "CREATE TABLE `z_record` (`license` varchar(255) NOT NULL DEFAULT '豫A88888', `pid` int unsigned NOT NULL DEFAULT '0', `sid` int unsigned NOT NULL DEFAULT '0', `entry_time` bigint unsigned DEFAULT '0', PRIMARY KEY (`license`));"
